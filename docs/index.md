...
- `GET /v1/models` — The protocol model deck this runner routes to (flat `models` list, plus `aliases`/`waterfalls` routing extensions); optional single `?type=` category filter
