...
class TestErrorResponses:
    ...
    def test_forbidden_is_rfc7807(self):
        ...
        response = client.post(
            "/v1/execute",
            json={"mthds_contents": {"a.mthds": ""}, "pipe_code": "smoke", "orchestration_mode": "definitely-not-the-default"},
        )
    ...
    def test_unauthenticated_carries_www_authenticate_challenge(self):
        ...
        response = _build_client(user=None, with_auth=True).post("/v1/validate", json={"mthds_contents": {"a.mthds": ""}})
